...
const RajeshFlatEditForm = lazy(() => import("./pages/rajeshFlat.jsx"));
		...
		<SimpleErrorBoundary>
			<Suspense fallback={<GlobalFallback />}>
				<Routes>
					...
					{/* Edit Form - Rajesh Flat - Protected Route with Lazy Loading */}
					<Route
						path="/valuationeditformrajeshflat/:id"
						element={
							<ProtectedRoute>
								<RajeshFlatEditForm user={user} onLogin={handleLogin} />
							</ProtectedRoute>
						}
					/>
