...
<!-- END: letterhead-section -->
      ...
      <div style="margin-top: 20px;">
        <table style="width: 100%; border-collapse: collapse; border: 1px solid #000; font-size: 12pt; table-layout: fixed;">
          ...
          locality?</td>
            <td style="border: 1px solid #000; padding: 8px; width: 50%;">${safeGet(pdfData, 'pdfDetails.compositeTotalCompositeRate', 'NA')}</td>
          </tr>
          <tr>
            <td style="border: 1px solid #000; padding: 8px; width: 5%; font-weight: bold;">2.</td>
          ...
          under comparison (given details). </td>
            <td style="border: 1px solid #000; padding: 8px; width: 50%;">${safeGet(pdfData, 'pdfDetails.rateAnalysisAdoptedCompositeRate', 'NA')}</td>
          </tr>
          <tr>
            <td style="border: 1px solid #000; padding: 8px; width: 5%; font-weight: bold;">3.</td>
          ...
          <tr>
            ...
            <td style="border: 1px solid #000; padding: 8px; width: 50%;">${safeGet(pdfData, 'pdfDetails.rateAnalysisRateBreakupBuildingServices', 'NA')}</td>
          </tr>
          <tr>
            ...
            <td style="border: 1px solid #000; padding: 8px; width: 50%;">${safeGet(pdfData, 'pdfDetails.rateAnalysisRateBreakupLandOthers', 'NA')}</td>
          </tr>
          <tr>
            <td style="border: 1px solid #000; padding: 8px; width: 5%; font-weight: bold;">4.</td>
          ...
          Flat (evidence thereof to be enclosed) </td>
            <td style="border: 1px solid #000; padding: 8px; width: 50%;">${safeGet(pdfData, 'pdfDetails.rateAnalysisGuidelineRate', 'NA')}</td>
          </tr>
        </table>
      </div>
      <!-- END: rate-section -->
