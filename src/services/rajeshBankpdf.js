...
<div style="padding: 5px 20px; width: 100%; box-sizing: border-box; page-break-after: always !important;">
  <table style="width: 100%; border-collapse: collapse; margin-bottom: 10px; border: 1px solid #000 !important;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 8px; border: 1px solid #000 !important;">
  <tr >
  ...
  <tr >
    ...
    <td style="width: 50%; background: #ffffff; border: 1px solid #000 !important; padding: 5px 6px; font-size: 12pt; vertical-align: top;">${safeGet(pdfData, 'pdfDetails.accountName') || safeGet(pdfData, 'accountName') || 'NA'}</td>
  </tr>
</table>
...
<table style="width: 100%; border-collapse: collapse; border: 1px solid #000000; margin-bottom: 0; margin-top: 10px;">
  <tr>
...
from the date of the report. Simply possessing the report will not fulfill its intended purpose. 
  ...
  <div style="margin: 60px 0 0 0; text-align: right;">
   ...
   <p style="margin: 2px 0; font-size: 12pt; line-height: 1.6;">Chartered Engineer (India), B.E. Civil, PMP (PMI USA)</p>
    ...
    <p style="margin: 9px 0 2px 0; font-size: 12pt; line-height: 1.5;">5th floor, Shalvik Complex, behind Ganesh Plaza,</p>
